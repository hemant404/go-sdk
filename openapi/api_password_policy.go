...
type PasswordPolicyAPI interface {
	...
	/*
		GetPasswordPolicy Retrieve Password policy
	...
	*/
	...
	GetPasswordPolicyExecute(r ApiGetPasswordPolicyRequest) (*PasswordPolicy, *http.Response, error)
	...
	*/
	UpdatePasswordPolicy(ctx context.Context) ApiUpdatePasswordPolicyRequest

	// UpdatePasswordPolicyExecute executes the request
	//  @return PasswordPolicy
	UpdatePasswordPolicyExecute(r ApiUpdatePasswordPolicyRequest) (*PasswordPolicy, *http.Response, error)
}
...
func (a *PasswordPolicyAPIService) GetPasswordPolicyExecute(r ApiGetPasswordPolicyRequest) (*PasswordPolicy, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v2/manage/password-policies"
...
Updates the Password policy settings for a specific Tenant.
	...
	@return ApiUpdatePasswordPolicyRequest
*/
func (a *PasswordPolicyAPIService) UpdatePasswordPolicy(ctx context.Context) ApiUpdatePasswordPolicyRequest {
	return ApiUpdatePasswordPolicyRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return PasswordPolicy
func (a *PasswordPolicyAPIService) UpdatePasswordPolicyExecute(r ApiUpdatePasswordPolicyRequest) (*PasswordPolicy, *http.Response, error) {
	var (
