...
func (o *DeleteResponse) GetIsDeleted() bool {
...
func (o *DeleteResponse) GetIsDeletedOk() (*bool, bool) {
	if o == nil || IsNil(o.IsDeleted) {
		return nil, false
	}
...
func (o *DeleteResponse) HasIsDeleted() bool {
	if o != nil && !IsNil(o.IsDeleted) {
		return true
	}
...
func (o *DeleteResponse) SetIsDeleted(v bool) {
	o.IsDeleted = &v
}
