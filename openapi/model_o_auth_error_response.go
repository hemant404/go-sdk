...
// checks if the OAuthErrorResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OAuthErrorResponse{}

// OAuthErrorResponse struct for OAuthErrorResponse
...
func NewOAuthErrorResponse() *OAuthErrorResponse {
...
func (o *OAuthErrorResponse) GetError() string {
...
func (o *OAuthErrorResponse) GetErrorOk() (*string, bool) {
	if o == nil || IsNil(o.Error) {
		return nil, false
	}
	return o.Error, true
...
func (o *OAuthErrorResponse) SetError(v string) {
	o.Error = &v
}
...
func (o OAuthErrorResponse) ToMap() (map[string]interface{}, error) {
